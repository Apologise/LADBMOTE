...
public class MultiKernelMultiPara2 {
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		"ecoli1", "ecoli2", "ecoli3","ecoli4" ,"ecoli0v1", "yeast1", "yeast3",
		"yeast4","yeast5","yeast6","glass0", "glass1", "glass2",
		"glass4",“glass6”,"glass016v2"
		 */
		String[] dataSets = {
				"ecoli1"
				};
		...
		for (int dataset = 0; dataset < dataSets.length; ++dataset) {
			...
			double thetapara[] = {0.001,0.005,0.01,0.05,0.1,0.5, 1 };
